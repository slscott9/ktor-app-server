...
import com.sscott.data.*
import com.sscott.data.collections.Note
import com.sscott.data.requests.AddOwnerRequest
import com.sscott.data.requests.DeleteNoteRequest
...
fun Route.noteRoute() {
    route("/getNotes"){
        ...
        //Whoever makes a request to getNotes must be authenticated
        authenticate {
            get {
    ...
    route("/addOwnerToNote"){
        authenticate {
            post {
                ...
                //check if the owner we want to add is an actual user that exists
                //check if that user is already an owner of the note
                //and if none of these are the case add the user as the owner of this note
